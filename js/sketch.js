...
function preload() {
  blockImg = loadImage('https://math.seattleacademy.org/aldencutler/2113-5/img/block.png');
  clack = loadSound('https://math.seattleacademy.org/aldencutler/2113-5/clack.wav');
}
